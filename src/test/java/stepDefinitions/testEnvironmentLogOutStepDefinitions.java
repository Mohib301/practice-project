...
import pageObjects.testEvironmentLogOutPageObject;

public class testEnvironmentLogOutStepDefinitions extends Base {

	
	testEvironmentLogOutPageObject test = new testEvironmentLogOutPageObject();
	...
	public void myacoount_must_have_Register_and_Login_options() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
	   test.myAccountVerificationElement();
	}
