...
public class TekSchoolScenarioStepDefinitions extends Base {
...
public void user_connect_to_DataBase() throws Throwable {
    // Write code here that turns the phrase above into concrete actions
    DBUtilities.setupConnection();
}

@When("^User sends query '(.+)'$")
public void user_sends_query_select_from_public_customer_where_email_ross_grey_sakilacustomer_org(String query) throws Throwable {
    // Write code here that turns the phrase above into concrete actions
    DBUtilities.runQuery(query);
}

@Then("^User verify account is created with email '(.+)'$")
public void user_verify_account_is_created_with_ross_grey_sakilacustomer_org() throws Throwable {
    // Write code here that turns the phrase above into concrete actions
